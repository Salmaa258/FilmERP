    ...
    */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers("/moduls", "/moduls/**", "/llistatPelicules", "/infoPelicules").authenticated()
                .requestMatchers("/activarDesactivarModuls").hasAnyAuthority("Administrador") //només administradors
                .requestMatchers("/llistatDirectors").permitAll()
                .requestMatchers("/afegirPelicules").hasAnyAuthority("Administrador")
                .requestMatchers("/editarPelicules").hasAnyAuthority("Administrador")
                
                //.requestMatchers("/afegirDirectors", "/editarDirectors").hasAnyAuthority("Administrador")
